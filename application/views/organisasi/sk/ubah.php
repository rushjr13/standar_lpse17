			...
			<div class="card shadow border-primary">
				...
				<div class="card-body">
					<div class="form-group row">
					    ...
					    <input type="text" class="form-control shadow-sm" id="nomor_sko" name="nomor_sko" placeholder="Nomor SK" value="<?=$sk_organisasi['nomor_sko'] ?>">
					    ...
					    <input type="date" class="form-control shadow-sm" id="tanggal_sko" name="tanggal_sko" placeholder="Tanggal SK" value="<?=$sk_organisasi['tanggal_sko'] ?>">
				  ...
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control shadow-sm" id="nama_sko" name="nama_sko" placeholder="Nama SK" value="<?=$sk_organisasi['nama_sko'] ?>">
				  ...
				  <div class="form-group">
				    ...
				    <textarea class="form-control shadow-sm" id="tentang_sko" name="tentang_sko" placeholder="SK Tentang"><?=$sk_organisasi['tentang_sko'] ?></textarea>
				  ...
				  <div class="form-group">
				    ...
				    <div class="custom-file">
						  <input type="hidden" class="form-control shadow-sm" id="file_lama_sko" name="file_lama_sko" value="<?=$sk_organisasi['file_sko'] ?>">
						  <input type="file" class="custom-file-input shadow-sm" id="file_sko" name="file_sko">
