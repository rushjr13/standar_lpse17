			...
			<div class="card shadow border-primary">
				...
				<div class="card-body">
					<div class="form-group row">
					    ...
					    <input type="text" class="form-control" id="nomor_sko" name="nomor_sko" placeholder="Nomor SK" value="<?=set_value('nomor_sko') ?>">
					    ...
					    <input type="date" class="form-control" id="tanggal_sko" name="tanggal_sko" placeholder="Tanggal SK" value="<?=set_value('tanggal_sko') ?>">
				  ...
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" id="nama_sko" name="nama_sko" placeholder="Nama SK" value="<?=set_value('nama_sko') ?>">
				  ...
				  <div class="form-group">
				    ...
				    <textarea class="form-control" id="tentang_sko" name="tentang_sko" placeholder="SK Tentang"><?=set_value('tentang_sko') ?></textarea>
				  ...
				  <div class="form-group">
				    ...
				    <div class="custom-file">
						  <input type="file" class="custom-file-input" id="file_sko" name="file_sko" required>
