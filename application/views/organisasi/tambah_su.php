<form action="<?=base_url('organisasi/tambah_tupoksi/') ?>" method="post">
	<div class="card border-primary shadow mb-3">
		...
		<div class="card-body">
		    ...
		    <div class="col-sm-10">
		      <input type="text" class="form-control" id="jabatan_su" name="jabatan_su" autofocus>
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="tugas_su">Tugas & Tanggung Jawab</label>
				<textarea class="form-control ckeditor" id="tugas_su" name="tugas_su" placeholder="Tugas & Tanggung Jawab"></textarea>
		  </div>
		</div>
	</div>
</form>