          ...
          <tr>
            ...
            <td class="align-middle text-center">
              ...
              <?php if($akses_menu['username']==$pengguna_masuk['username']){ ?>
                <a href="<?=base_url('resiko/form/layanan/ubah/').$rlayanan['id'] ?>" class="btn shadow-sm btn-sm btn-circle btn-info" title="Ubah"><i class="fa fa-fw fa-edit"></i></a>
                <button type="button" class="btn shadow-sm btn-sm btn-circle btn-danger" id="hapusresikolayanan" data-toggle="modal" data-target="#hapusresikolayananModal" data-id="<?=$rlayanan['id'] ?>" title="Hapus"><i class="fa fa-fw fa-trash"></i></button>
              <?php } ?>
            </td>
          </tr>
        <?php endforeach ?>
