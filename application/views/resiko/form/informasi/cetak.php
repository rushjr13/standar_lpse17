...
<body id="page-top">
  ...
  <div class="alert alert-ligth text-center" role="alert">
    ...
    <hr>
    <p class="mb-0 font-weight-bold">INFORMASI</p>
  </div>
            ...
            <tr>
              ...
              <td class="align-middle">
                <?php if($ri['dampak']==1){echo 'Tidak ada';}else{ ?>
                  ...
                  <small class="text-primary"><small>REPUTASI :</small></small><br><?=$ri['reputasi'] ?><hr class="m-1">
                  <small class="text-primary"><small>PIDANA :</small></small><br><?=$ri['pidana'] ?><hr class="m-1">
                  <small class="text-primary"><small>KINERJA :</small></small><br><?=$ri['kinerja'] ?>
                <?php } ?>
              </td>
              <td class="align-middle"><?=$ri['dampak'] ?></td>
              <td class="align-middle"><?=$ri['tingkat_pengancam'] ?></td>
              <td class="align-middle"><?=$ri['pengancam'] ?></td>
              <td class="align-middle"><?=$ri['tingkat_rentan'] ?></td>
              <td class="align-middle"><?=$ri['kerentanan'] ?></td>
              <td class="align-middle"><?=$ri['tingkat_paparan'] ?></td>
              <td class="align-middle"><?=$ri['paparan'] ?></td>
