			...
			<form action="<?=base_url('perubahan/form/ubah_implementasi/').$perubahan['id_perubahan'] ?>" method="post">
				...
				<div class="card-body">
				  <div class="form-group row">
				    ...
				    <div class="col-sm-8">
				      <textarea class="form-control shadow-sm" id="test_perubahan" name="test_perubahan" placeholder="Hasil Tes Perubahan" autofocus><?=$perubahan['test_perubahan'] ?></textarea>
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-8">
				      <textarea class="form-control shadow-sm" id="implementasi_perubahan" name="implementasi_perubahan" placeholder="Hasil Implementasi Perubahan"><?=$perubahan['implementasi_perubahan'] ?></textarea>
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-8">
				      <input type="date" class="form-control shadow-sm" id="tgl_implementasi" name="tgl_implementasi" value="<?=$perubahan['tgl_implementasi'] ?>">
