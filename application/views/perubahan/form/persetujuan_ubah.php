			...
			<form action="<?=base_url('perubahan/form/ubah_persetujuan/').$perubahan['id_perubahan'] ?>" method="post">
				...
				<div class="card-body">
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-8">
				      <textarea class="form-control shadow-sm" id="ket_statuspermintaan" name="ket_statuspermintaan" placeholder="Keterangan" autofocus><?=$perubahan['ket_statuspermintaan'] ?></textarea>
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-8">
				      <input type="date" class="form-control shadow-sm" id="jadwal_perubahan" name="jadwal_perubahan" value="<?=$perubahan['jadwal_perubahan'] ?>">
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-8">
				      <input type="text" class="form-control shadow-sm" id="petugas_implementasi" name="petugas_implementasi" placeholder="Penugasan Untuk Implementasi (Nama)" value="<?=$perubahan['petugas_implementasi'] ?>">
