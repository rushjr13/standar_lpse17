	...
	<div class="col-8">
		<form action="<?=base_url('aset/form/layanan/ubah/').$aset_layanan['idl'] ?>" method="post">
			<div class="card shadow border-primary">
				<div class="card-header shadow-sm bg-primary text-white">Ubah Aset Layanan <?=$aset_layanan['nama'] ?></div>
				<div class="card-body">
          ...
          <div class="form-group row">
            <div class="col-md-6">
              <input type="text" class="form-control shadow-sm" id="nama" name="nama" placeholder="Nama Layanan" value="<?=$aset_layanan['nama'] ?>">
          ...
          <div class="form-group row">
            <div class="col-md-4">
              <input type="text" class="form-control shadow-sm" id="pemilik" name="pemilik" placeholder="Pemilik Aset" value="<?=$aset_layanan['pemilik'] ?>">
              <?php echo form_error('pemilik', '<small class="text-danger ml-2" style="font-style:italic;">', '</small>'); ?>
            </div>
            <div class="col-md-4">
              <input type="text" class="form-control shadow-sm" id="pemegang" name="pemegang" placeholder="Pemegang Aset" value="<?=$aset_layanan['pemegang'] ?>">
              <?php echo form_error('pemegang', '<small class="text-danger ml-2" style="font-style:italic;">', '</small>'); ?>
            </div>
            <div class="col-md-4">
              <input type="text" class="form-control shadow-sm" id="penyedia" name="penyedia" placeholder="Penyedia Aset" value="<?=$aset_layanan['penyedia'] ?>">
          ...
          <div class="form-group row">
            <div class="col-md-6">
              <input type="text" class="form-control shadow-sm" id="kontrak_no" name="kontrak_no" placeholder="Jabatan" value="<?=$aset_layanan['kontrak_no'] ?>">
              <?php echo form_error('kontrak_no', '<small class="text-danger ml-2" style="font-style:italic;">', '</small>'); ?>
            </div>
            <div class="col-md-6">
              <input type="date" class="form-control shadow-sm" id="kontrak_berlaku" name="kontrak_berlaku" placeholder="No. Kontrak/NDA" value="<?=$aset_layanan['kontrak_berlaku'] ?>">
              <?php echo form_error('kontrak_berlaku', '<small class="text-danger ml-2" style="font-style:italic;">', '</small>'); ?>
            </div>
          </div>
          <div class="form-group row">
            <div class="col-md-12">
              <input type="text" class="form-control shadow-sm" id="kontrak_deskripsi" name="kontrak_deskripsi" placeholder="Atasan Langsung" value="<?=$aset_layanan['kontrak_deskripsi'] ?>">
          ...
          <div class="form-group">
            <textarea class="form-control shadow-sm" id="keterangan" name="keterangan" placeholder="Keterangan Tambahan"><?=$aset_layanan['keterangan'] ?></textarea>
          </div>
				</div>
