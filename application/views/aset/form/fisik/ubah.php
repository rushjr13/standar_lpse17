  ...
  <div class="col-8">
    <form action="<?=base_url('aset/form/fisik/ubah/').$aset_fisik['idf'] ?>" method="post">
      <div class="card shadow border-primary">
        <div class="card-header shadow-sm bg-primary text-white">Ubah Aset Fisik</div>
        <div class="card-body">
          ...
          <div class="form-group row">
            <div class="col-md-6">
              <input type="text" class="form-control shadow-sm" id="nama" name="nama" placeholder="Nama Aset" value="<?=$aset_fisik['nama'] ?>">
          ...
          <div class="form-group">
            <textarea class="form-control shadow-sm" id="spesifikasi" name="spesifikasi" placeholder="Spesifikasi Aset"><?=$aset_fisik['spesifikasi'] ?></textarea>
          ...
          <div class="form-group row">
            <div class="col-md-4">
              <input type="text" class="form-control shadow-sm" id="pemilik" name="pemilik" placeholder="Pemilik" value="<?=$aset_fisik['pemilik'] ?>">
              <?php echo form_error('pemilik', '<small class="text-danger ml-2" style="font-style:italic;">', '</small>'); ?>
            </div>
            <div class="col-md-4">
              <input type="text" class="form-control shadow-sm" id="penyedia" name="penyedia" placeholder="Penyedia" value="<?=$aset_fisik['penyedia'] ?>">
              <?php echo form_error('penyedia', '<small class="text-danger ml-2" style="font-style:italic;">', '</small>'); ?>
            </div>
            <div class="col-md-4">
              <input type="text" class="form-control shadow-sm" id="pemegang" name="pemegang" placeholder="Pemegang" value="<?=$aset_fisik['pemegang'] ?>">
              <?php echo form_error('pemegang', '<small class="text-danger ml-2" style="font-style:italic;">', '</small>'); ?>
            </div>
          </div>
          <div class="form-group row">
            <div class="col-md-6">
              <input type="text" class="form-control shadow-sm" id="lokasi" name="lokasi" placeholder="Lokasi Aset" value="<?=$aset_fisik['lokasi'] ?>">
              <?php echo form_error('lokasi', '<small class="text-danger ml-2" style="font-style:italic;">', '</small>'); ?>
            </div>
            <div class="col-md-6">
              <input type="date" class="form-control shadow-sm" id="berlaku" name="berlaku" placeholder="Masa Berlaku" value="<?=$aset_fisik['berlaku'] ?>">
          ...
          <div class="form-group">
            <textarea class="form-control shadow-sm" id="keterangan" name="keterangan" placeholder="Keterangan Tambahan"><?=$aset_fisik['keterangan'] ?></textarea>
          </div>
        </div>
