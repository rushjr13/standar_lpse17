	...
	<div class="col-8">
		<form action="<?=base_url('aset/form/intangible/ubah/').$aset_intangible['idi'] ?>" method="post">
			<div class="card shadow border-primary">
				<div class="card-header shadow-sm bg-primary text-white">Ubah Aset Intangible <?=$aset_intangible['nama'] ?></div>
				<div class="card-body">
          ...
          <div class="form-group row">
            <div class="col-md-6">
              <input type="text" class="form-control shadow-sm" id="nama" name="nama" placeholder="Nama Aset" value="<?=$aset_intangible['nama'] ?>">
          ...
          <div class="form-group row">
            <div class="col-md-12">
              <input type="text" class="form-control shadow-sm" id="pemilik" name="pemilik" placeholder="Pemilik Aset" value="<?=$aset_intangible['pemilik'] ?>">
          ...
          <div class="form-group">
            <textarea class="form-control shadow-sm" id="keterangan" name="keterangan" placeholder="Keterangan Tambahan"><?=$aset_intangible['keterangan'] ?></textarea>
          </div>
				</div>
