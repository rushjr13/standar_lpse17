	...
	<div class="col-8">
		<form action="<?=base_url('aset/form/informasi/ubah/').$aset_informasi['id'] ?>" method="post">
			<div class="card shadow border-primary">
				<div class="card-header bg-primary text-white">Ubah Aset Informasi : <?=$aset_informasi['nama'] ?></div>
				<div class="card-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Aset" value="<?=$aset_informasi['nama'] ?>">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="format" name="format" placeholder="Format Penyimpanan" value="<?=$aset_informasi['format'] ?>">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-4">
              <input type="text" class="form-control" id="pemilik" name="pemilik" placeholder="Pemilik Aset" value="<?=$aset_informasi['pemilik'] ?>">
            ...
            <div class="col-sm-4">
              <input type="text" class="form-control" id="berlaku" name="berlaku" placeholder="Masa Berlaku" value="<?=$aset_informasi['berlaku'] ?>" required>
            </div>
          </div>
          <hr>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <textarea class="form-control" id="keterangan" name="keterangan" placeholder="Keterangan Tambahan"><?=$aset_informasi['keterangan'] ?></textarea>
            </div>
          </div>
				</div>
