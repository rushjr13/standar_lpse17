<form action="<?=base_url('kapasitas/form/laporan/').$kapasitas_laporan['id_kapasitas'] ?>" method="post">
	<div class="card shadow border-primary">
		<div class="card-header shadow-sm bg-primary text-white">
			...
			<a href="<?=base_url('kapasitas/form/cetak/').$kapasitas_laporan['id_kapasitas'] ?>" target="_blank" class="btn shadow-sm btn-sm btn-circle btn-primary float-right mr-2" title="Cetak Laporan"><i class="fa fa-fw fa-print"></i></a>
			<button type="submit" class="btn shadow-sm btn-sm btn-circle btn-primary float-right mr-2" title="Simpan"><i class="fa fa-fw fa-save"></i></button>
		</div>
		<div class="card-body ">
			<!-- PENDAHULUAN -->
			<div class="alert shadow-sm alert-success mb-3">
				<h5>PENDAHULUAN</h5>
				<hr class="mt-0">
				<div class="row">
					<div class="col-lg-6">
						<div class="card shadow-sm mb-3">
							<div class="card-header shadow-sm bg-light">Latar Belakang</div>
							<div class="card-body">
						...
						<div class="card shadow-sm mb-3">
							<div class="card-header shadow-sm bg-light">Ruang Lingkup</div>
							<div class="card-body">
								<div class="form-group m-0">
					...
					<div class="col-lg-6">
						<div class="card shadow-sm mb-3">
							<div class="card-header shadow-sm bg-light">Metode Pengumpulan Data</div>
							<div class="card-body">
								<div class="form-group m-0">
						...
						<div class="card shadow-sm mb-3">
							<div class="card-header shadow-sm bg-light">Asumsi-Asumsi Yang Digunakan</div>
							<div class="card-body">
								<div class="form-group m-0">
			...
			<!-- RINGKASAN -->
			<div class="alert shadow-sm alert-warning mb-3">
				<h5>RINGKASAN LAYANAN</h5>
				<hr class="mt-0">
				<div class="row">
					<div class="col-lg-6">
						<div class="card shadow-sm mb-3">
							<div class="card-header shadow-sm bg-light">Laporan Layanan Saat Ini</div>
							<div class="card-body">
								<div class="form-group m-0">
					...
					<div class="col-lg-6">
						<div class="card shadow-sm mb-3">
							<div class="card-header shadow-sm bg-light">Prediksi Layanan Akan Datang</div>
							<div class="card-body">
								<div class="form-group m-0">
			...
			<div class="alert shadow-sm alert-success mb-3">
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="card shadow-sm mb-3">
							<div class="card-header shadow-sm bg-light">Laporan Penggunaan Komponen Pendukung</div>
							<div class="card-body">
								<div class="form-group m-0">
					...
					<div class="col-lg-6">
						<div class="card shadow-sm mb-3">
							<div class="card-header shadow-sm bg-light">Analisis Trend Penggunaan Komponen Pendukung</div>
							<div class="card-body">
								<div class="form-group m-0">
					...
					<div class="col-lg-12">
						<div class="card shadow-sm mb-3">
							<div class="card-header shadow-sm bg-light">Prediksi Kebutuhan Komponen Pendukung</div>
							<div class="card-body">
								<div class="form-group m-0">
			...
			<div class="alert shadow-sm alert-warning mb-3">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card shadow-sm mb-3">
							<div class="card-header shadow-sm bg-light">Opsi Tindakan Yang Dapat Diambil Untuk Mengantisipasi Terjadinya Kekurangan Kapasitas</div>
							<div class="card-body">
								<div class="form-group m-0">
			...
			<div class="alert shadow-sm alert-success mb-3">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="card shadow-sm mb-3">
							<div class="card-header shadow-sm bg-light">Perkiraan Biaya Yang Harus Dikeluarkan Untuk Mengantisipasi Terjadinya Kekurangan Kapasitas</div>
							<div class="card-body">
								<div class="form-group m-0">
			...
			<div class="alert shadow-sm alert-warning m-0">
				<h5>REKOMENDASI TERKAIT RENCANA KAPASITAS</h5>
				<hr class="mt-0">
				<div class="row">
					<div class="col-lg-12">
						<div class="card shadow-sm mb-3">
							<div class="card-header shadow-sm bg-light">Rekomendasi Tindakan Untuk Mengantisipasi Terjadinya Kekurangan Kapasitas Dalam Bentuk Rencana Peningkatan Kapasitas</div>
							<div class="card-body">
								<div class="form-group m-0">
