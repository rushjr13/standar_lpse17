			...
			<div class="col-lg-4">
				<div class="alert shadow border-dark">
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-lg-9">
				      <input type="text" class="form-control" id="item" name="item" placeholder="Item" autofocus value="<?=set_value('item') ?>">
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-lg-9">
				      <textarea class="form-control" id="batasan" name="batasan"><?=set_value('batasan') ?></textarea>
				...
				<div class="alert shadow border-dark">
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-lg-7">
				      <input type="date" class="form-control" id="waktu_pantau" name="waktu_pantau" value="<?=date('Y-m-d', time()) ?>">
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-lg-10">
				      <textarea class="form-control" id="utilitas" name="utilitas"><?=set_value('utilitas') ?></textarea>
				...
				<div class="alert shadow border-dark">
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-lg-8">
				      <textarea class="form-control" id="perkiraan_resource" name="perkiraan_resource"><?=set_value('perkiraan_resource') ?></textarea>
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-lg-8">
				      <textarea class="form-control" id="tindak_lanjut" name="tindak_lanjut"><?=set_value('tindak_lanjut') ?></textarea>
			...
			<div class="col-lg-8">
				<div class="alert shadow border-dark">
					...
					<div class="alert shadow border-dark">
					    ...
					    <div class="col-lg-10">
					      <textarea class="form-control" id="kondisi_p1" name="kondisi_p1"><?=set_value('kondisi_p1') ?></textarea>
					  ...
					  <div class="form-group row">
					    ...
					    <div class="col-lg-10">
					      <textarea class="form-control" id="kondisi_p2" name="kondisi_p2"><?=set_value('kondisi_p2') ?></textarea>
					    </div>
					  </div>
					  <div class="form-group row">
					    <label for="kondisi_p3" class="col-lg-2 col-form-label">Parameter 3<br><small class="text-muted"><em>(Opsional)</em></small></label>
					    <div class="col-lg-10">
					      <textarea class="form-control" id="kondisi_p3" name="kondisi_p3"><?=set_value('kondisi_p3') ?></textarea>
					    </div>
					  </div>
					  <div class="form-group row">
					    <label for="kondisi_p4" class="col-lg-2 col-form-label">Parameter 4<br><small class="text-muted"><em>(Opsional)</em></small></label>
					    <div class="col-lg-10">
					      <textarea class="form-control" id="kondisi_p4" name="kondisi_p4"><?=set_value('kondisi_p4') ?></textarea>
					    </div>
					  </div>
					</div>
					...
					<div class="alert shadow border-dark">
					    ...
					    <div class="col-lg-10">
					      <textarea class="form-control" id="perkiraan_p1" name="perkiraan_p1"><?=set_value('perkiraan_p1') ?></textarea>
					  ...
					  <div class="form-group row">
					    ...
					    <div class="col-lg-10">
					      <textarea class="form-control" id="perkiraan_p2" name="perkiraan_p2"><?=set_value('perkiraan_p2') ?></textarea>
					    </div>
					  </div>
					  <div class="form-group row">
					    <label for="perkiraan_p3" class="col-lg-2 col-form-label">Parameter 3<br><small class="text-muted"><em>(Opsional)</em></small></label>
					    <div class="col-lg-10">
					      <textarea class="form-control" id="perkiraan_p3" name="perkiraan_p3"><?=set_value('perkiraan_p3') ?></textarea>
					    </div>
					  </div>
					  <div class="form-group row">
					    <label for="perkiraan_p4" class="col-lg-2 col-form-label">Parameter 4<br><small class="text-muted"><em>(Opsional)</em></small></label>
					    <div class="col-lg-10">
					      <textarea class="form-control" id="perkiraan_p4" name="perkiraan_p4"><?=set_value('perkiraan_p4') ?></textarea>
					    </div>
					  </div>
					</div>
				</div>
